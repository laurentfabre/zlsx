...
The gate is exit 0 in both directions with the same-binary control
taken first, as M10k's window-drift lesson requires. This window was
quiet — the M10n binary re-measured at its recorded 73 596 928 B on
all three runs.
