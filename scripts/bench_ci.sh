...
"$ZIG_BIN" build-exe \
    ...
    --dep zlsx_sst_plan --dep zlsx_styles_plan --dep zlsx_workbook_xml_plan --dep zlsx_zip --dep zlsx_sheet_plan --dep zlsx_fresh_emit --dep zlsx_nfc -Mzlsx=src/xlsx.zig \
