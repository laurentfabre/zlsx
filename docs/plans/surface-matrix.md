...
| S7b | **Reference move landed 2026-08-29** (first PR) — §3 the source-sheet row: `worksheetSource@ref` / `rangeSet@ref` move by range semantics, the host-and-source refusal lifted (footnote ¹⁰); the refresh marker and the cache rebuild follow. C and Py observe it through S3a. |
