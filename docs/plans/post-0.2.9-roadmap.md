...
| **B3** Writer rebase onto Workbook | ⏳ pending — proposed iter-wr-0..7 sketched in `~/.claude/projects/-Users-lf-Projects-Pro-zlsx/memory/project_iter_er_3_pre_work.md` (2026-05-09 chat synthesis). Suggested first move: wr-0 inventory pass producing `docs/plans/writer-rebase.md`. |
