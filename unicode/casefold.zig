...
//! `unicode/tables/casefold_data.zig`, generated by
//! `scripts/gen_unicode_tables.py` from `CaseFolding.txt`.
//!
//! Folding is **not** casing, and the distinction is why `casing.zig`
//! sits beside this file rather than inside it: `fold("ß")` is `"ss"`
//! (a lowercase key for comparison) where `UPPER("ß")` is `"SS"` (a
//! visible uppercase result). One is a comparison key nobody displays,
//! the other is a value a cell shows.
//!
//! Two entry points:
//!
